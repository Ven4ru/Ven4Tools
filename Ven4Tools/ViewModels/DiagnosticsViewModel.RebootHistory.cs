    ...
    public sealed partial class DiagnosticsViewModel
    {
        ...
        private async Task<List<RebootDiagnosis>> RunRebootHistoryCheckAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                RebootStatusRow = new DiagnosticsTextRow { Text = "Недоступно: не удалось прочитать журнал событий.", ForegroundKey = "StatusWarning" };
            ...
            {
                RebootStatusRow = new DiagnosticsTextRow { Text = "За последние 7 дней нештатных завершений работы не найдено.", ForegroundKey = "StatusSuccess" };
                ShowRebootStatusRow = true;
                return diagnoses;
            }
