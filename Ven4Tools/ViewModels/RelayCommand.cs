...
namespace Ven4Tools.ViewModels
{
    public sealed class RelayCommand : ICommand
    {
        ...
        /// сбоя в проекте уже закрывали точечно — у установки из пина, переустановки из
        /// истории, карточки приложения и повтора неудачной установки, — но каждый раз
        /// отдельной копией try/catch в конкретном месте, из-за чего асинхронные команды
        /// каталога так и остались без защиты. Здесь перехват сделан один раз для всех
        /// сразу.</para>
        /// </summary>
