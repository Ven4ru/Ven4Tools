...
namespace Ven4Tools.Services
{
    ...
    internal static class AuthenticodeVerifier
    {
        public static bool IsSignedByMicrosoft(string filePath, out string error)
        {
            ...
            // Проверка отзыва (revocation) идёт по всей цепочке сертификатов, но
            // требует сети. Если онлайн-статус отзыва получить не удалось (нет сети /
